...
TimestampRotatingFileSink::TimestampRotatingFileSink(const std::string& base_filename,
                                                     size_t max_size,
                                                     size_t max_files,
                                                     bool compress)
...
void TimestampRotatingFileSink::sink_it_(const spdlog::details::log_msg& msg) {
...
void TimestampRotatingFileSink::flush_() {
    std::lock_guard<std::mutex> lock(mutex_);
    file_.Flush();
}

std::string TimestampRotatingFileSink::GetTimestampStr() {
...
void TimestampRotatingFileSink::Rotate() {
    file_.Close();
...
void TimestampRotatingFileSink::CleanupOldFiles() {
